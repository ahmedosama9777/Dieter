...
namespace Dieter {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class trainerDataTable : global::System.Data.TypedTableBase<trainerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public trainerRow AddtrainerRow(int ID, string Fname, string Lname, string Degree, string Pass_word) {
        ...
        public partial class trainerRow : global::System.Data.DataRow {
            ...
            public string Degree {
                get {
                    return ((string)(this[this.tabletrainer.DegreeColumn]));
                }
                set {
                    this[this.tabletrainer.DegreeColumn] = value;
                }
            }
            ...
            public string Pass_word {
                get {
                    return ((string)(this[this.tabletrainer.Pass_wordColumn]));
                }
                set {
                    this[this.tabletrainer.Pass_wordColumn] = value;
                }
            }
        }
...
namespace Dieter.DataSet3TableAdapters {
    ...
    public partial class trainerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[trainer] WHERE (([ID] = @Original_ID) AND ([Fname] = @Original" +
                "_Fname) AND ([Lname] = @Original_Lname) AND ([Degree] = @Original_Degree) AND ([" +
                "Pass_word] = @Original_Pass_word))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[trainer] ([ID], [Fname], [Lname], [Degree], [Pass_word]) VALUE" +
                "S (@ID, @Fname, @Lname, @Degree, @Pass_word);\r\nSELECT ID, Fname, Lname, Degree, " +
                "Pass_word FROM trainer WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[trainer] SET [ID] = @ID, [Fname] = @Fname, [Lname] = @Lname, [Degree] = @Degree, [Pass_word] = @Pass_word WHERE (([ID] = @Original_ID) AND ([Fname] = @Original_Fname) AND ([Lname] = @Original_Lname) AND ([Degree] = @Original_Degree) AND ([Pass_word] = @Original_Pass_word));
SELECT ID, Fname, Lname, Degree, Pass_word FROM trainer WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Fname, Lname, Degree, Pass_word FROM dbo.trainer";
        ...
        public virtual int Fill(DataSet3.trainerDataTable dataTable) {
        ...
        public virtual DataSet3.trainerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet3.trainerDataTable dataTable = new DataSet3.trainerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet3.trainerDataTable dataTable) {
